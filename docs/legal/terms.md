...
- **Application** means the software program provided by @willtheorangeguy downloaded by you on any electronic device, named Nginx File Directory.
...
If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company. Contact information is available on the [GitHub](https://github.com/willtheorangeguy/Nginx-File-Directory) page.
