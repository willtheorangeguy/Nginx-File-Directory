...
The following versions of the Nginx File Directory are currently supported:
...
Please open an [issue](https://github.com/willtheorangeguy/Nginx-File-Directory/issues/new) to report a security vulnerability. Please include the requested information listed below (as much as you can provide) to help us better understand the nature and scope of the possible issue:
